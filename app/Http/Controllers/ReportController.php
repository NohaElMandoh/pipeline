...
class ReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $opportunities    = $this->opportunityRepo->search(
            [ 'Keyword' => $request->name,'Stage'=>$request->stage_id,'Month'=>$request->month,'Customer'=>$request->customer_id],
            ['stages','customer','lastStage'],true, false, false,'created_at', 'ASC');
    

        return view('admin.report.timeline', compact('title', 'opportunities', 'customers', 'services', 'stages'));
    }
